...
function Navbar() {
    ...
    return (
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4 bg-amber-500'>
            ...
            {/* Side drawer-menu */}
            <div className={
                nav ? 'fixed top-0 left-0 z-10 w-[300px] h-screen bg-white duration-300' : 'fixed top-0 left-[-100%] z-10 w-[300px] h-screen bg-white duration-300'}>
